...
type RegistryReqUserInfo struct {
	Username string `json:"username"`
	Password string `json:"password"`
}

type RegistryRespUserInfo struct {
	Username  string `json:"username"`
...
type RegistryReq struct {
	...
	User     RegistryReqUserInfo
}

type RegistryResp struct {
	Entities []RegistryRespUserInfo `json:"entities"`
}

type BatchRegistryReq struct {
	AppToken string                `json:"app_token"`
	Users    []RegistryReqUserInfo `json:"users"`
}
